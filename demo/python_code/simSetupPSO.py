...
WG = WorldGenerator(particle_id=args.particle_id, instance_id=args.instance_id, fill_ratio=args.fill_ratio, robot_number=args.num_robots, path=args.path, dynamic_env=args.dynamic_env, env_upper=args.env_upper, env_lower=args.env_lower)
